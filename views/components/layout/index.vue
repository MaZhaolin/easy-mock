<template>
  <div class="em-layout">
    ...
    <div v-shortkey="['p']"
         @shortkey="$router.push('/')"></div>
    <div v-shortkey="['g']"
         @shortkey="$router.push('/group')"></div>
    <div v-shortkey="['w']"
         @shortkey="$router.push('/workbench')"></div>
    <div v-shortkey="['d']"
         @shortkey="$router.push('/docs')"></div>
    <div v-shortkey="['n']"
         @shortkey="$router.push('/new')"></div>
    <div v-shortkey="['s']"
         @shortkey="onSearch"></div>

    <transition name="fade">
      <div class="em-layout__nav"
           v-show="pageAnimated">
        <Menu theme="dark"
              :active-name="pageKey"
              mode="horizontal">
    ...
    <p class="em-layout__copyright"
       v-if="copyright && pageAnimated">{{copyright}}</p>
  </div>
</template>
